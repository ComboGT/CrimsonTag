...
namespace GorillaNetworking
{
	public class CosmeticsController : MonoBehaviour
	{
		...
		private string bundleSkuName_ = "2023_sweet_heart_bundle";

		private string bundlePlayfabItemName_ = "LSAAS.";

		private int bundleShinyRocks_;
		...
		public string BundleSkuName => bundleSkuName_;

		public string BundlePlayfabItemName => bundlePlayfabItemName_;

		public int BundleShinyRocks => bundleShinyRocks_;
		...
		public void PressEarlyAccessButton()
		{
			...
			shinyRocksCost = BundleShinyRocks;
			SteamPurchase();
			...
			PlayFabClientAPI.GetUserInventory(new GetUserInventoryRequest(), delegate(GetUserInventoryResult result)
			{
				...
				}, delegate(GetCatalogItemsResult result2)
				{
					...
					foreach (ItemInstance item in result.Inventory)
					{
						...
						{
							if (item.ItemId == BundlePlayfabItemName)
							{
