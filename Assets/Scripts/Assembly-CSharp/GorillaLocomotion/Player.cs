...
namespace GorillaLocomotion
{
	public class Player : MonoBehaviour
	{
		...
		{
			int num = Physics.RaycastNonAlloc(startPosition, (endPosition - startPosition).normalized, rayCastNonAllocColliders, (endPosition - startPosition).magnitude, locomotionEnabledLayers.value, QueryTriggerInteraction.Ignore);
			int num2 = 0;
			for (int i = 0; i < num; i++)
			{
