namespace emotitron.Compression
{
	public static class BitCounter
	{
		...
		public static int UsedBitCount(this uint val)
		{
			...
			val |= val >> 8;
			val |= val >> 16;
			return bitPatternToLog2[(ulong)((long)val * 7783611145303519083L) >> 57];
		}
		...
		public static int UsedBitCount(this int val)
		{
			...
			val |= val >> 8;
			val |= val >> 16;
			return bitPatternToLog2[(ulong)(val * 7783611145303519083L) >> 57];
		}
		...
		public static int UsedBitCount(this ushort val)
		{
			...
			num |= num >> 4;
			num |= num >> 8;
			return bitPatternToLog2[(ulong)((long)num * 7783611145303519083L) >> 57];
		}
